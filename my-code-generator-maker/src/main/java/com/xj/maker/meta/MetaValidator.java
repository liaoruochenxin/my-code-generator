...
import com.xj.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    private static void validAndFillFileConfig(Meta meta) {
        ...
        for (Meta.FileConfig.FileInfo fileInfo : fileInfoList) {
            ...
            // generateType: 如果文件结尾不为ftl,则为static，否则为dynamic
    ...
    private static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "小蒋");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.xj");

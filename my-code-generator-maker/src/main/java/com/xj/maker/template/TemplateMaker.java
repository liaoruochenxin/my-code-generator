...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String inputFilePath = "src/com/xj/algorithm/MainTemplate.java";
...
//        String searchStr = "Sum: ";
        ...
        long id = makeTemplate(meta, originProjectPath, inputFilePath, modelInfo, searchStr, 1979125439712923648L);
